...
<head>
    ...
    <title>RH - EmployeeManager</title>
    ...
    <style>
        ...
        * {
        ...
        /* Profile Button */
        .profile-btn, .notifications-btn, .attendances-btn {
        ...
        .profile-btn:hover, .notifications-btn:hover, .attendances-btn:hover {
            background: var(--primary-blue-dark);
        ...
        .chat-window {
            ...
            bottom: 20px;
            right: 20px;
            width: 420px; /* Increased width for larger size */
            max-height: 80vh; /* Increased max-height for larger size */
        ...
        .chat-window .chat {
            ...
            flex-direction: column;
            gap: 1rem;
            max-height: calc(80vh - 120px); /* Adjusted to prevent overflow to top */
        }
        ...
        .chat-window .input-area input {
            ...
            border-radius: 25px;
            font-size: 1rem; /* Slightly larger font for input */
            outline: none;
            background: var(--white);
            transition: all 0.3s ease;
        }
        ...
        .chat-window .input-area button {
            display: none; /* Hidden as per Anaconda style, using Enter key instead */
        }
...
<body>
    <div class="sidebar animate__animated animate__fadeInLeft">
        ...
        <ul class="sidebar-nav">
            <li><a href="/RHdashboard" class="dashboard"><i class="fas fa-tachometer-alt"></i><span>Dashboard</span></a></li>
            <li><a href="/RHallemp" class="allemp"><i class="fas fa-users"></i><span>All Employees</span></a></li>
            <li><a href="/RHaddemp" class="addemp"><i class="fas fa-user-plus"></i><span>Add Employees</span></a></li>
            <li><a href="/RHdocumentRequests" class="docsreqs"><i class="fas fa-file-alt"></i><span>Document Requests</span></a></li>
            <li><a href="/RHleavesRequests" class="leavesreqs"><i class="fas fa-calendar-check"></i><span>Leaves Requests</span></a></li>
            <li><a href="/attendance" class="attendance"><i class="fas fa-calendar"></i><span>My Attendance</span></a></li>
            <li><a href="/RHpublishNews" class="pubnews"><i class="fas fa-bullhorn"></i><span>Publish News</span></a></li>
            <li><a href="/RHlogs" class="logs"><i class="fas fa-history"></i><span>My Logs</span></a></li>
        </ul>
    </div>
    ...
    <div class="main-content">
        <div class="header-bar">
            ...
            <a href="/attendances" class="attendances-btn animate__animated animate__fadeIn">
            ...
            <a href="/RHprofile" class="profile-btn animate__animated animate__fadeIn">
    ...
    <section class="chat-window">
        ...
        <div class="chat">
            <div class="timestamp">May 18 2025, 8:19 PM</div>
            <div class="model">
