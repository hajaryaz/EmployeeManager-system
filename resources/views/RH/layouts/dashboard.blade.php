...
@section('content')
    ...
    <div class="welcome-header animate__animated animate__fadeIn">
        ...
        <p>Streamline your HR tasks with our intuitive dashboard.</p>
    </div>
        ...
        <div class="col-lg-4 col-md-6">
            <div class="card animate__animated animate__fadeInUp">
                ...
                <div class="card-body">
                    ...
                    <a href="/activeemp" class="btn btn-primary">View All</a>
                </div>
            </div>
        </div>
        <div class="col-lg-4 col-md-6">
            <div class="card animate__animated animate__fadeInUp" style="animation-delay: 0.2s;">
                ...
                <div class="card-body">
                    ...
                    <a href="/RHdocumentRequests" class="btn btn-primary">Manage</a>
                </div>
            </div>
        </div>
        <div class="col-lg-4 col-md-6">
            <div class="card animate__animated animate__fadeInUp" style="animation-delay: 0.4s;">
                ...
                <div class="card-body">
                    ...
                    <a href="/inactiveemp" class="btn btn-primary">View all</a>
                </div>
            </div>
        </div>
        <div class="col-lg-8">
            <div class="card animate__animated animate__fadeInUp" style="animation-delay: 0.6s;">
                ...
                <div class="card-body">
                    ...
                    @endforeach
                    <a href="/allnews" class="btn btn-primary mt-3">View all news</a>
                </div>
            </div>
        </div>
        <div class="col-lg-4">
            <div class="card animate__animated animate__fadeInUp" style="animation-delay: 0.8s;">
                ...
                <div class="card-body">
                    <ul class="list-unstyled">
                        <li class="mb-3">
                            <a href="/RHaddemp" class="btn btn-outline-primary w-100 text-start py-2">
                                <i class="fas fa-user-plus me-2"></i>Add New Employee
                            </a>
                        </li>
                        <li class="mb-3">
                            <a href="/completeddocs" class="btn btn-outline-primary w-100 text-start py-2">
                                <i class="fas fa-clipboard-list me-2"></i>Completed documents
                            </a>
                        </li>
                        <li>
                            <a href="/approvedleaves" class="btn btn-outline-primary w-100 text-start py-2">
