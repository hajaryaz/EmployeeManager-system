    ...
    <style>
        ...
        * {
        ...
        .login-header::before {
            ...
            width: 100%;
            height: 100%;
            background: url('data:image/svg+xml;base64,');
            opacity: 0.25;
        }
                    ...
                    <div class="login-card animate__animated animate__fadeInUp">
                        <div class="login-header">
                            <h3 class="mb-0">
                                ...
                                <span>Welcome {{ explode(' ', $user->nomComplet)[0] }}</span>
                            </h3>
                            <p class="mt-2 mb-0">Enter your new password below</p>
                        </div>
                        <div class="login-body">
                            <form method="POST" action="{{ route('forgotpass.handler', ['id' => $user->id]) }}">
                                @csrf
                                <div class="mb-4">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input id="password" type="password" class="form-control" name="password" 
                                            required placeholder="Enter new password" aria-describedby="passwordError">
